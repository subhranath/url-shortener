...
DATABASES = {
    'default': {
        ...
        'NAME': 'url_shortener',                      # Or path to database file if using sqlite3.
        'USER': 'url_shortener',                      # Not used with sqlite3.
        'PASSWORD': 'url_shortener',                  # Not used with sqlite3.
...
SECRET_KEY = '+t416&1qxk0f)hqs3=z5+)l$q5!mdgm!@s5k54^=ea_2vlf22s'
